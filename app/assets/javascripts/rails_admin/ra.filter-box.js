      ...
      switch(field_type) {
        case 'boolean':
          var control = '<select class="input-small" name="' + value_name + '">' +
            ...
            '<option ' + (field_value == "_present" ? 'selected="selected"' : '') + ' value="_present">Присутствует</option>' +
            '<option ' + (field_value == "_blank"   ? 'selected="selected"' : '') + ' value="_blank"  >Пустое</option>' +
          '</select>';
          break;
        case 'date':
        case 'datetime':
        case 'timestamp':
          var control = '<select class="switch-additionnal-fieldsets input-xlarge" name="' + operator_name + '">' +
            '<option ' + (field_operator == "default"   ? 'selected="selected"' : '') + ' data-additional-fieldset="default" value="default">Дата ...</option>' +
            '<option ' + (field_operator == "between"   ? 'selected="selected"' : '') + ' data-additional-fieldset="between" value="between">Между ... и ...</option>' +
            '<option ' + (field_operator == "today"   ? 'selected="selected"' : '') + ' value="today">Сегодня</option>' +
            '<option ' + (field_operator == "yesterday"   ? 'selected="selected"' : '') + ' value="yesterday">Вчера</option>' +
            '<option ' + (field_operator == "this_week"   ? 'selected="selected"' : '') + ' value="this_week">На этой неделе</option>' +
            '<option ' + (field_operator == "last_week"   ? 'selected="selected"' : '') + ' value="last_week">На прошлой неделе</option>' +

            '<option disabled="disabled">---------</option>' +
            '<option ' + (field_operator == "more_than_days"   ? 'selected="selected"' : '') + ' data-additional-fieldset="more_than_days" value="more_than_days">Больше чем … дней назад</option>' +
            '<option ' + (field_operator == "more_than_months"   ? 'selected="selected"' : '') + ' data-additional-fieldset="more_than_months" value="more_than_months">Больше чем … месяцев назад</option>' +

            '<option disabled="disabled">---------</option>' +
            '<option ' + (field_operator == "_not_null" ? 'selected="selected"' : '') + ' value="_not_null">Присутствует</option>' +
            '<option ' + (field_operator == "_null"     ? 'selected="selected"' : '') + ' value="_null" >Пустое</option>' +
          '</select>'
          var additional_control =
            ...
            '<input class="additional-fieldset more_than_days input-small" style="display:' + ((field_operator == "more_than_days") ? 'inline-block' : 'none') + ';" type="text" name="' + value_name + '[]" value="' + (field_value[3] || '') + '" /> ' +
            '<input class="additional-fieldset more_than_months input-small" style="display:' + ((field_operator == "more_than_months") ? 'inline-block' : 'none') + ';" type="text" name="' + value_name + '[]" value="' + (field_value[4] || '') + '" /> ';
          break;
        case 'enum':
        ...
        case 'belongs_to_association':
          var control = '<select class="switch-additionnal-fieldsets input-small" value="' + field_operator + '" name="' + operator_name + '">' +
            '<option data-additional-fieldset="additional-fieldset"'  + (field_operator == "like"        ? 'selected="selected"' : '') + ' value="like">Содержит</option>' +
            '<option data-additional-fieldset="additional-fieldset"'  + (field_operator == "is"          ? 'selected="selected"' : '') + ' value="is">Равно</option>' +
            '<option data-additional-fieldset="additional-fieldset"'  + (field_operator == "starts_with" ? 'selected="selected"' : '') + ' value="starts_with">Начинается с</option>' +
            '<option data-additional-fieldset="additional-fieldset"'  + (field_operator == "ends_with"   ? 'selected="selected"' : '') + ' value="ends_with">Заканчивается на</option>' +
            '<option disabled="disabled">---------</option>' +
            '<option ' + (field_operator == "_present"    ? 'selected="selected"' : '') + ' value="_present">Присутствует</option>' +
            '<option ' + (field_operator == "_blank"      ? 'selected="selected"' : '') + ' value="_blank">Пустое</option>' +
          '</select>'
        ...
        case 'float':
          var control = '<select class="switch-additionnal-fieldsets input-small" name="' + operator_name + '">' +
            '<option ' + (field_operator == "default"   ? 'selected="selected"' : '') + ' data-additional-fieldset="default" value="default">Число ...</option>' +
            '<option ' + (field_operator == "between"   ? 'selected="selected"' : '') + ' data-additional-fieldset="between" value="between">Между ... и ...</option>' +
            '<option disabled="disabled">---------</option>' +
            '<option ' + (field_operator == "_not_null" ? 'selected="selected"' : '') + ' value="_not_null">Присутствует</option>' +
            '<option ' + (field_operator == "_null"     ? 'selected="selected"' : '') + ' value="_null" >Пустое</option>' +
